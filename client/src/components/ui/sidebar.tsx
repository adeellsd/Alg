    ...
    <SidebarContext.Provider value={contextValue}>
      <TooltipProvider delayDuration={0}>
        <div
          ...
          className={cn(
            "group/sidebar-wrapper flex min-h-svh w-full bg-gray-50",
            className
          )}
          {...props}
        >
      ...
      >
        <div
          ...
          className={cn(
            ...
            variant === "floating" && "rounded-lg border border-gray-200 shadow-sm"
          )}
        >
          {children}
        </div>
...
function SidebarInput({
  ...
  return (
    <Input
      ...
      data-sidebar="input"
      className={cn("h-8 w-full bg-gray-50 shadow-none", className)}
      {...props}
    />
  )
}
...
function SidebarGroupLabel({
  ...
  return (
    <Comp
      ...
      className={cn(
        "flex h-8 shrink-0 items-center rounded-md px-2 text-xs font-medium text-gray-500",
...
const sidebarMenuButtonVariants = cva(
  cn(
    "peer/menu-button flex w-full items-center gap-2 overflow-hidden rounded-lg p-2 text-left text-sm",
    "text-gray-700 transition-colors duration-150",
    "hover:bg-gray-100 hover:text-gray-900",
    "focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-cyan-500",
    "disabled:pointer-events-none disabled:opacity-50",
    "aria-disabled:pointer-events-none aria-disabled:opacity-50",
    "data-[active=true]:bg-cyan-50 data-[active=true]:text-cyan-700 data-[active=true]:font-medium",
  ...
  return (
    <Comp
      ...
      className={cn(
        ...
        "disabled:pointer-events-none disabled:opacity-50",
        "aria-disabled:pointer-events-none aria-disabled:opacity-50",
        "data-[active=true]:bg-cyan-50 data-[active=true]:text-cyan-700",
        "[&>span:last-child]:truncate [&>svg]:size-4 [&>svg]:shrink-0",
        size === "sm" && "text-xs",
        size === "md" && "text-sm",
        "group-data-[collapsible=icon]:hidden",
