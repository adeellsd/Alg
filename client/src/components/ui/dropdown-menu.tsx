  ...
  return (
    <DropdownMenuPrimitive.Portal>
      <DropdownMenuPrimitive.Content
        ...
        className={cn(
          // Base
          "z-50 min-w-40 overflow-hidden rounded-lg border border-gray-200 bg-white/95 backdrop-blur-md p-1 shadow-lg",
          // Animation
...
function DropdownMenuItem({
  ...
  "relative flex cursor-pointer select-none items-center gap-2 rounded-md px-2 py-1.5 text-sm outline-none transition-colors",
        // States
  "text-gray-700 focus:bg-gray-100 focus:text-gray-900 focus-visible:ring-2 focus-visible:ring-blue-pale",
        // Variants
...
function DropdownMenuRadioItem({
  ...
  return (
    ...
    >
      <span className="absolute left-2 flex size-4 items-center justify-center">
        <DropdownMenuPrimitive.ItemIndicator>
          <CircleIcon className="size-2 fill-cyan-600 text-cyan-600" />
        </DropdownMenuPrimitive.ItemIndicator>
      </span>
      {children}
    </DropdownMenuPrimitive.RadioItem>
...
function DropdownMenuSubContent({
  ...
  return (
    <DropdownMenuPrimitive.SubContent
      ...
      className={cn(
  "z-50 min-w-32 overflow-hidden rounded-lg border border-gray-200 bg-white/95 backdrop-blur-md p-1 shadow-lg",
        "data-[state=open]:animate-in data-[state=closed]:animate-out",
        "data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0",
        "data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95",
        "data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2",
