  ...
  return (
    <Dialog {...props}>
      ...
      <DialogContent className={cn("overflow-hidden p-0", className)}>
        <Command className="**:[[cmdk-group-heading]]:px-2 **:[[cmdk-group-heading]]:py-1.5 **:[[cmdk-group-heading]]:text-xs **:[[cmdk-group-heading]]:font-medium **:[[cmdk-group-heading]]:text-gray-500 **:[[cmdk-group]]:px-2 **:[[cmdk-item]]:px-2 **:[[cmdk-item]]:py-2.5">
          {children}
        </Command>
      </DialogContent>
    </Dialog>
...
function CommandInput({
  ...
  return (
    <div
      ...
      className="flex items-center gap-2 border-b border-gray-200 px-3"
    >
      <Search className="size-4 shrink-0 text-gray-400" />
      <CommandPrimitive.Input
        data-slot="command-input"
        className={cn(
          "flex h-11 w-full bg-transparent py-3 text-sm text-gray-900 placeholder:text-gray-400 outline-none",
  ...
  return (
    <CommandPrimitive.Item
      ...
      className={cn(
        ...
        "[&_svg]:size-4 [&_svg]:shrink-0 [&_svg]:text-gray-500",
        className
      )}
      {...props}
    />
